...
) : BaseApiController
{
  ...
  [HttpPost("webhook")]
  public async Task<ActionResult<BasketDto>> StripeWebhook()
  {
  ...
  private async Task HandlePaymentIntentSucceeded(PaymentIntent intent)
  {
    ...
    order.OrderStatus = (order.GetTotal() == intent.Amount)
  ...
  private Event ConstructStripeEvent(string json)
  {
    try
    {
      ...
      var stripeSettingsSecret = config["StripeSettings:WhSecret"];
      return EventUtility.ConstructEvent(json, stripeSignatureHeader, stripeSettingsSecret);
    }
    catch (Exception ex)
    {
