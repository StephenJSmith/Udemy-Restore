...
public class DiscountService
{
  ...
  public async Task<AppCoupon?> GetCouponFromPromoCode(string code)
  {
    ...
    if (promotionCode == null || promotionCode.Coupon == null) return null;
    ...
    return new AppCoupon
    {
      ...
      PromotionalCode = promotionCode.Coupon.Id,
      CouponId = promotionCode.Coupon.Id
    };
  }

  public async Task<long> CalculateDiscountFromAmount(
    AppCoupon appCoupon, long amount, bool removeDiscount = false)
  {
